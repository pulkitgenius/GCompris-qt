...
function initLevel() {
    ...
    var dropItemComponent = Qt.createComponent("qrc:/gcompris/src/activities/find_in_sentence/DropAnswerItem.qml")
    var textItemComponent = Qt.createComponent("qrc:/gcompris/src/activities/find_in_sentence/TextItem.qml")
    var sentenceItemComponent = Qt.createComponent("qrc:/gcompris/src/activities/find_in_sentence/SentenceItem.qml")
    ...
    while(levelDataLength--) {
        ...
        //3- then mutilple choices words : *COD|COI
            ...
            while ((elementsBetweenBrackets = re.exec(str)) != null) {
                ...
                sentenceSegments.push(plainText)
                ...
                sentenceSegments.push(wordsToAnalyse)
                ...
                sentenceSegments.push(multipleChoicesElements)
            ...
            showText[k++] = sentenceItemComponent.createObject(
                            items.backgroundImage, {
                              //  "choices": choices,
                              //  "choicesOk": choicesOk,
                              //  "choicesNotOk": choicesNotOk,
